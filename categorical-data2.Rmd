...
ggplot(
  ...
  geom_area(
    mapping=aes(
      x=x,
      y=y,
      fill=factor(fill, levels=c("y_c", "y_b", "y_a"))
    ),
    color="white"
  )
```

  * fill's aesthetic mapping is related to RHS fill's levels.
  
  * position stock sequence, however, is determined by group mapping variable levels. 
